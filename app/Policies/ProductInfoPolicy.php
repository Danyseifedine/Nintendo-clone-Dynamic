...
class ProductInfoPolicy
{
    ...
    {
        return $user->can('viewAny_product::info');
    }
    ...
    {
        return $user->can('create_product::info');
    }
    ...
    {
        return $user->can('update_product::info');
    }
    ...
    {
        return $user->can('delete_product::info');
    }
     ...
     */
    public function replicate(User $user, ProductInfo $productInfo): bool
    {
